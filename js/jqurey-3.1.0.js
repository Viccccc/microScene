...
function(a, b) {
  ...
  C = /^.[^:#\[\.,]*$/;
  function D(a, b, c) {
    if (r.isFunction(b)) return r.grep(a,
    function(a, d) {
      return !! b.call(a, d, a) !== c
    });
    if (b.nodeType) return r.grep(a,
    function(a) {
      return a === b !== c
    });
    if ("string" == typeof b) {
  ...
  r.event = {
    ...
    special: {
      ...
      focus: {
        trigger: function() {
          if (this !== va() && this.focus) return this.focus(),
          !1
        },
      ...
      blur: {
        trigger: function() {
          if (this === va() && this.blur) return this.blur(),
          !1
        },
  ...
  r.extend({
    ...
    clone: function(a, b, c) {
      ...
      if (b) if (c) for (f = f || la(a), g = g || la(h), d = 0, e = f.length; d < e; d++) Fa(f[d], g[d]);
      else Fa(a, h);
  ...
  function Ma(a, b, c) {
    ...
    return c = c || La(a),
    c && (g = c.getPropertyValue(b) || c[b], "" !== g || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), !o.pixelMarginRight() && Ka.test(g) && Ja.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)),
    void 0 !== g ? g + "": g
  }
  function Na(a, b) {
    return {
  ...
  function(a, b) {
    r.cssHooks[b] = {
      get: function(a, c, d) {
        if (c) return ! Oa.test(r.css(a, "display")) || a.getClientRects().length && a.getBoundingClientRect().width ? Wa(a, b, d) : ca(a, Pa,
        function() {
          return Wa(a, b, d)
        })
      },
  ...
  r.cssHooks.marginLeft = Na(o.reliableMarginLeft,
  function(a, b) {
  ...
  function(a, b) {
    r.cssHooks[a + b] = {
      expand: function(c) {
        for (var d = 0,
        e = {},
        f = "string" == typeof c ? c.split(" ") : [c]; d < 4; d++) e[a + aa[d] + b] = f[d] || f[d - 2] || f[0];
        return e
      }
    },
    ...
    valHooks: {
      ...
      select: {
        get: function(a) {
          ...
          e = a.selectedIndex,
          f = "select-one" === a.type,
          g = f ? null: [], h = f ? e + 1 : d.length, i = e < 0 ? h: f ? e: 0; i < h; i++) if (c = d[i], (c.selected || i === e) && !c.disabled && (!c.parentNode.disabled || !r.nodeName(c.parentNode, "optgroup"))) {
  ...
  r.each(["top", "left"],
  function(a, b) {
    r.cssHooks[b] = Na(o.pixelPosition,
    function(a, c) {
